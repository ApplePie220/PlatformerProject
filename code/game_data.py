level_0 = {
    ...
    'fg trees': '../levels/0/level_0._fg_trees.csv',
    'bg trees': '../levels/0/level_0._bg_trees.csv',
...
level_1 = {
    ...
    'fg trees': '../levels/1/level_1_fg_trees.csv',
    'bg trees': '../levels/1/level_1_bg_trees.csv',
...
level_2 = {
    ...
    'fg trees': '../levels/2/level_2_fg_trees.csv',
    'bg trees': '../levels/2/level_2_bg_trees.csv',
...
level_3 = {
    ...
    'fg trees': '../levels/3/level_3_fg_trees.csv',
    'bg trees': '../levels/3/level_3_bg_trees.csv',
...
level_4 = {
    ...
    'fg trees': '../levels/4/level_4_fg_trees.csv',
    'bg trees': '../levels/4/level_4_bg_trees.csv',
...
level_5 = {
    ...
    'fg trees': '../levels/5/level_5_fg_trees.csv',
    'bg trees': '../levels/5/level_5_bg_trees.csv',
